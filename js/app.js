...
nomore.addEvenetListener("click", lessContent);

function lessContent (){
	document.getElementById("less").style.visibility = "hidden";
	nomore.appendChild(lessContent);
...
var menuItems = ["filet-o-fish", "chicken nuggets", "french fries"];
...
function randoQuote(){
	...
	displayQuotes.innerHTML = quotes[ran];
}
